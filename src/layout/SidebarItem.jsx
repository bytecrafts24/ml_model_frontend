...
// export default function SidebarItem({ item, drawerOpen, isOpen, handleToggle }) {
//   return (
//     <>
//       <ListItem
//         button
//         onClick={() => item.children ? handleToggle(item.id) : null}
//         component={item.path ? Link : 'div'}
//         to={item.path || undefined}
//         sx={{ justifyContent: 'space-between', padding: '10px 16px' }}
//       >
...
//               >
//                 {subItem.icon}
//                 {drawerOpen && <ListItemText primary={subItem.label} />}
//               </ListItem>
//             ))}
//           </List>
//         </Collapse>
